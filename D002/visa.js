function myFunction() {
  ...
  document.getElementsByClassName("card")[0].style.backgroundColor = "gold";
  document.getElementsByClassName("card")[0].innerHTML = `<div class="header">
...
<div class="content">
  <div class="row">
    ...
    <input
      type="text"
      class="card-number"
      placeholder="1234 009 435 112"
    />
  </div>
  <div class="row card-expired">
    <div class="row card-expired-month">
      <label>Month</label>
      <input type="text" placeholder="April" />
    </div>
    <div class="row card-expired-year">
      <label>Year</label>
